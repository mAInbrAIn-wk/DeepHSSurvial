...
### 1.3 Stochastische Noten-Schwelle (Der "Bestehens-Würfel")
* **Status Quo:** Ein Student besteht ein Modul deterministisch, wenn seine berechnete `leistung` (inklusive Support) einen Hard-Cutoff übersteigt (`<= 4.0`).
