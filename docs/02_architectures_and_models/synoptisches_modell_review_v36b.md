...
| Modell | Architektur | Next-Exam Noten-$R^2$ | Next-Exam Noten-RMSE | Pass/Fail ROC-AUC | Pass/Fail PR-AUC |
| :--- | :--- | :---: | :---: | :---: | :---: |
| **Autoregressive Dual-Head (GRU/Dense)** | GRU-History + Dense-Context | **0,4430** | **0,8719** | **0,9371** | **0,9952** |
| **Autoregressive Deep Transformer** | 3-Block Transformer ($d=64$, 4 Heads, SinCos) | **0,4769** | **0,8412** | **0,9420** | **0,9961** |
