...
def build_recurrent_survival_dataset_delta(data_dir: Path, max_semesters: int = 16):
    ...
    n_features = 13 # [gpa, cp, fails, cp_rueckstand, fach_cnt, uebf_cnt, psych_cnt, hzb, erw, erst, cum_fails_vor, delta_gpa, mig]
    ...
    print(f"GRU Semester Delta Tensor aufgebaut (13 Features): X={X_seq.shape}")
